...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel platypodes = createHeader("Platypodes");
		// 4. Add the header component to the quizPanel
		quizPanel.add(platypodes);
	...
	//	JOptionPane.showMessageDialog(null,"pressed " + ((JButton)arg0.getSource()).getText() + " button");
		...
		if(buttonPressed== firstButton){
			askQuestion("Are they omnivorous, or carnivorus?", "Carniovorus:", 100);
			firstButton.setText("");
		}else if(buttonPressed == secondButton){
			askQuestion("What is the most deadly thing about them?", "They are venomous", 200);
